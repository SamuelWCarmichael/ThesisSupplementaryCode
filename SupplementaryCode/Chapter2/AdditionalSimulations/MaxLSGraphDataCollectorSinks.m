...
for i = 5:0.5:30
    ...
    for f = 1:5000
        rowCount = rowCount + 1;
        flyOut = simulateSandflyVarMaxLSSinks();
...
csvwrite('MaxLSVarSinksDatM1.csv',outputV2);
...
csvwrite('MaxLSVarSinksDatM4.csv',outputV2);
outputV2 = zeros(255000,54);
rowCount = 0;
...
csvwrite('MaxLSVarSinksDatM7.csv',outputV2);
outputV2 = zeros(255000,54);
rowCount = 0;
...
csvwrite('MaxLSVarSinksDatM13.csv',outputV2);
outputV2 = zeros(255000,54);
rowCount = 0;
...
csvwrite('MaxLSVarSinksDatM18.csv',outputV2);