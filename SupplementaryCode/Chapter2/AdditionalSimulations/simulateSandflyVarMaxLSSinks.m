...
function F = simulateSandflyVarMaxLSSinks()
% No input currently, since this function shouldn't require any.

% Loading some important global variables.
global meanLS meanBiteFreq retroDevT biteScaleParam maxLifespan
...
while elapsedTime < lifespan
    ...
    if elapsedTime ~= endTime
        ...
        if infState == "Dediff"
            ...
            [t, pVec] = ode45(@dediffModelSinks, tSpan, ICVec);
        else
            % Either the bite was a while ago or the fly hasn't bitten.
            [t, pVec] = ode45(@retroModelSinks, tSpan, ICVec);
        end
