...
function [F,G,H] = discr0unweighteddebugcompsimrep(rType,infDur,symT, prop, reps)
...
for rep = 1:reps
    ...
    while max(wghArray(2,:)) > 0
        ...
        ind = pickRandom(wghArray(1,:)); % We pick a stub uniformly at random, which means higher degree people more likely to be chosen.
        ...
        nbh = pickRandom(wghArray(1,:)); % Choosing a neighbour by the same method, a stub at random.
